...
sym = sym.replace(/ؤ/g, "'e");
sym = sym.replace(/لا/g, "la");
sym = sym.replace(/ک/g, "ke");
sym = sym.replace(/پ/g, "pe");
sym = sym.replace(/چ/g, "che");
sym = sym.replace(/ژ/g, "je");
sym = sym.replace(/گ/g, "gu");
sym = sym.replace(/ی/g, "a");
sym = sym.replace(/ٔ/g, "");
sym = sym.replace(/ة/g, "h");
sym = sym.replace(/؟/g, "?");
sym = sym.replace(/!/g, "!");
